...
The goal of the project was to develop an reproducible workflow to  generate datasets of water level timeseries and extreme water levels based on the extended ERA5 reanalysis. The scripts in this repository were used to produce the GTSM-ERA5-E dataset and include the pre-processing of input data to hydrodynamic modelling, post-processing of water level timeseries, extreme value analysis and validation. 
