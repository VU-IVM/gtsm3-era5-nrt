...
def download_waterlevels(yr, mnth):
    ...
    outdir = os.path.join(path_dict['postproc'],'timeseries-GTSM-ERA5-dailymax-1979-2018')
    ...
    path_ncfile_wl = os.path.join(outdir_waterlevel, f'{experiment}_waterlevel_dailymax_{yr}_{mnth:02}_v1.nc')
    path_ncfile_surge = os.path.join(outdir_surge, f'{experiment}_surge_dailymax_{yr}_{mnth:02}_v1.nc')
